...
@section('title', 'FAQ Sirine Shopping - Questions/Réponses Détaillées | Boutique Déco Sousse')

@section('meta')
    <meta name="description"
        content="FAQ complète de Sirine Shopping : 50+ questions/réponses sur commandes, livraisons, paiements, retours, garanties et services. Boutique déco à M'saken, Sousse.">
    <meta name="keywords"
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Comment passer commande sur Sirine Shopping ?",
          "acceptedAnswer": {
            "@type": "Answer",
    ...
    <section class="relative py-24 bg-gray-900 text-white overflow-hidden">
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div class="text-center max-w-4xl mx-auto">
                <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">Centre d'Aide Sirine Shopping</h1>
                            ...
                            <div
                                ...
                                <div class="faq-answer p-6 hidden bg-white">
                                    <div class="prose prose-primary max-w-none">
                                        <p>Pour commander sur Sirine Shopping, suivez ces étapes simples :</p>
