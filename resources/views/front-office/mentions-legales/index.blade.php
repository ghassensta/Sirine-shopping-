...
@section('title', 'Mentions Légales - Sirine Shopping Tunisie | Informations Légales')

@section('meta')
    <meta name="description" content="Mentions légales de Sirine Shopping Tunisie : informations sur l'éditeur, hébergement, protection des données et conditions d'utilisation du site.">
    ...
    <section class="relative bg-gray-800 text-white py-16 md:py-24">
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-xl text-gray-300">Informations légales de Sirine Shopping</p>
            </div>
        </div>
    </section>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="prose prose-lg max-w-none">
                    <div class="mb-12">
                        ...
                        <p><strong>Sirine Shopping SARL</strong>, société à responsabilité limitée au capital de 50 000 TND</p>
                    ...
                    <div class="mb-12">
                        ...
                        <p>Tous les éléments du site (textes, images, vidéos, logos, etc.) sont la propriété exclusive de Sirine Shopping ou de ses partenaires et sont protégés par les lois tunisiennes et internationales sur la propriété intellectuelle.</p>
