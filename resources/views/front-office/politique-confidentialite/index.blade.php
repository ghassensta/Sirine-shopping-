...
@section('title', 'Politique de Confidentialité Détaillée | Sirine Shopping Tunisie')

@section('meta')
    <meta name="description" content="Politique de confidentialité complète de Sirine Shopping : protection des données, cookies, droits RGPD, sécurité. Conforme à la loi tunisienne 2004-63.">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "PrivacyPolicy",
      "name": "Politique de Confidentialité Sirine Shopping",
      "datePublished": "2024-01-01",
      "url": "{{ url()->current() }}",
      "description": "Politique de protection des données personnelles de Sirine Shopping conforme à la législation tunisienne"
    }
    </script>
@endsection
            ...
            <div class="prose prose-primary max-w-none">
                ...
                <div id="introduction" class="mb-16 scroll-mt-24">
                    ...
                    <div class="border-l-4 border-primary pl-6 ml-3">
                        <p><strong>Sirine Shopping SARL</strong> ("nous", "notre", "nos"), immatriculée au registre du commerce de Sousse sous le numéro B123456789, s'engage à protéger la vie privée de ses utilisateurs conformément à :</p>
                        ...
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                            ...
                            <div class="bg-gray-50 p-3 rounded-lg">
                                ...
                                <dd>Sirine Shopping qui détermine les finalités du traitement</dd>
                            </div>
                            <div class="bg-gray-50 p-3 rounded-lg">
                    ...
                    <div class="border-l-4 border-primary pl-6 ml-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg">
                                ...
                                <address class="not-italic">
                                    <p class="mb-2">Sirine Shopping SARL</p>
