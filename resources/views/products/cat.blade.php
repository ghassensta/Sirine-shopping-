...
<head>
    ...
    <title>Sirine Shopping | Catégories</title>
...
<body>
    ...
    <header class="header">
        <div class="container">
            <a href="/" class="flex items-center">
                <img src="{{ asset('assets/img/logo-image.jpg') }}" loading="lazy" alt="Sirine Shopping" />
            </a>
    ...
    <footer class="bg-gray-100 py-16 border-t border-gray-200">
        ...
        <div class="text-center text-xs text-gray-400 mt-10">© {{ date('Y') }} Sirine Shopping. Tous droits réservés.</div>
    </footer>
