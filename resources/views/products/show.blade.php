...
<head>
    ...
    <title>Bougie Parfumée Eucalyptus | Sirine Shopping</title>
    ...
    <meta property="og:title" content="Bougie Parfumée Eucalyptus | Sirine Shopping">
...
<body class="bg-gray-50 font-sans text-gray-800">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            <a href="/" class="flex items-center">
                <img src="{{ asset('assets/img/logo-image.jpg') }}" alt="Sirine Shopping" class="h-12" />
            </a>
    ...
    <footer class="bg-gray-100 py-16 border-t border-gray-200">
        ...
        <div class="text-center text-xs text-gray-400 mt-10">© {{ date('Y') }} Sirine Shopping. Tous droits
            réservés.</div>
    </footer>
